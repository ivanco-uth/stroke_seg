...
from keras.layers import Input, LeakyReLU, Add, UpSampling3D, Activation, SpatialDropout3D, Conv3D, Conv3DTranspose, BatchNormalization
...
def i_model(input_shape=(128, 128, 128, 1), n_base_filters=32, depth=3, dropout_rate=0.3,
                      n_segmentation_levels=1, n_labels=1, activation_name="sigmoid"):
...
def create_up_sampling_module(input_layer, n_filters, size=(2, 2, 2)):
    ...
    up_sample = Conv3DTranspose(filters=n_filters, kernel_size=(2, 2, 2), strides=(2, 2, 2))(input_layer)
